...
const alertSchema = new mongoose.Schema({
  ...
  verificationLevel: { type: String, enum: ['official','reputable-report','corroborated'], default: 'official' },
  fingerprint: { type: String, index: true },
  firstSeenAt: { type: Date, default: Date.now },
  lastSeenAt: { type: Date, default: Date.now },
  lastChangedAt: { type: Date, default: Date.now },
  confirmationCount: { type: Number, default: 1 },
  changeType: { type: String, enum: ['NEW','UPDATED','UNCHANGED'], default: 'NEW' },
